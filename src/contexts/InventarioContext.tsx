...
// Los movimientos demo están anclados a fechas fijas (la más reciente: 2026-05-25).
// Para que el filtro "Hoy" de la vista de Movimientos siempre tenga datos visibles,
// se recalculan en cada carga desplazando todo el lote para que esa última fecha caiga hoy.
const MOVIMIENTOS_SHIFT_DIAS = Math.floor(
  (Date.now() - new Date("2026-05-25T00:00:00Z").getTime()) / 86_400_000
);
function shiftDate(iso: string): string {
  const d = new Date(`${iso}T00:00:00Z`);
  d.setUTCDate(d.getUTCDate() + MOVIMIENTOS_SHIFT_DIAS);
...
const DEMO_MOVIMIENTOS: InvMovimiento[] = [
  ...
  { id: "MOV-001", catalogo_id: "INV-001", cliente_id: "1", productor_id: "1",
    ...
    fecha: shiftDate("2026-04-30"), usuario_id: "3", created_at: shiftDateTime("2026-04-30T08:00:00Z") },
  { id: "MOV-002", catalogo_id: "INV-001", cliente_id: "1", productor_id: "1",
    ...
    fecha: shiftDate("2026-05-07"), usuario_id: "3", created_at: shiftDateTime("2026-05-07T10:00:00Z") },
  { id: "MOV-003", catalogo_id: "INV-001", cliente_id: "1", productor_id: "1",
    ...
    registro_origen_tipo: "PACKING_LIST",
    fecha: shiftDate("2026-05-12"), usuario_id: "3", created_at: shiftDateTime("2026-05-12T09:00:00Z") },
  { id: "MOV-004", catalogo_id: "INV-001", cliente_id: "1", productor_id: "1",
    ...
    registro_origen_tipo: "PACKING_LIST",
    fecha: shiftDate("2026-05-18"), usuario_id: "3", created_at: shiftDateTime("2026-05-18T11:00:00Z") },
  { id: "MOV-005", catalogo_id: "INV-001", cliente_id: "1", productor_id: "1",
    ...
    registro_origen_tipo: "PACKING_LIST",
    fecha: shiftDate("2026-05-24"), usuario_id: "3", created_at: shiftDateTime("2026-05-24T10:00:00Z") },
  ...
  { id: "MOV-006", catalogo_id: "INV-002", cliente_id: "1", productor_id: "1",
    ...
    fecha: shiftDate("2026-04-30"), usuario_id: "3", created_at: shiftDateTime("2026-04-30T08:30:00Z") },
  { id: "MOV-007", catalogo_id: "INV-002", cliente_id: "1", productor_id: "1",
    ...
    fecha: shiftDate("2026-05-05"), usuario_id: "3", created_at: shiftDateTime("2026-05-05T09:00:00Z") },
  { id: "MOV-008", catalogo_id: "INV-002", cliente_id: "1", productor_id: "1",
    ...
    registro_origen_tipo: "MOVIMIENTO_BODEGA",
    fecha: shiftDate("2026-05-12"), usuario_id: "3", created_at: shiftDateTime("2026-05-12T09:30:00Z") },
  { id: "MOV-009", catalogo_id: "INV-002", cliente_id: "1", productor_id: "1",
    ...
    fecha: shiftDate("2026-05-18"), usuario_id: "3", created_at: shiftDateTime("2026-05-18T11:30:00Z") },
  { id: "MOV-010", catalogo_id: "INV-002", cliente_id: "1", productor_id: "1",
    ...
    fecha: shiftDate("2026-05-25"), usuario_id: "3", created_at: shiftDateTime("2026-05-25T14:00:00Z") },
  ...
  { id: "MOV-021", catalogo_id: "INV-005", cliente_id: "1", productor_id: "2",
    ...
    fecha: shiftDate("2026-04-28"), usuario_id: "1", created_at: shiftDateTime("2026-04-28T08:00:00Z") },
  { id: "MOV-022", catalogo_id: "INV-005", cliente_id: "1", productor_id: "2",
    ...
    fecha: shiftDate("2026-05-05"), usuario_id: "7", created_at: shiftDateTime("2026-05-05T09:00:00Z") },
  { id: "MOV-023", catalogo_id: "INV-005", cliente_id: "1", productor_id: "2",
    ...
    fecha: shiftDate("2026-05-12"), usuario_id: "7", created_at: shiftDateTime("2026-05-12T10:00:00Z") },
  { id: "MOV-024", catalogo_id: "INV-005", cliente_id: "1", productor_id: "2",
    ...
    fecha: shiftDate("2026-05-19"), usuario_id: "7", created_at: shiftDateTime("2026-05-19T11:00:00Z") },
  { id: "MOV-025", catalogo_id: "INV-005", cliente_id: "1", productor_id: "2",
    ...
    fecha: shiftDate("2026-05-25"), usuario_id: "1", created_at: shiftDateTime("2026-05-25T16:00:00Z") },
