...
import {
  ...
  Upload, X, Plus, Save,
  Trash2, Info, CheckCircle2, Check, Clock, Archive, Database, Leaf, Search, Copy, History, User,
} from "lucide-react";
    ...
    <MainLayout>
      ...
      >
        <TabsList className="bg-muted p-1 rounded-lg flex-wrap gap-1 h-auto">
          ...
          <TabsTrigger value="usuarios"    disabled={hasPending && activeTab !== "usuarios"}    className="flex items-center gap-2 text-xs sm:text-sm">
