...
const navItems: NavItem[] = [
  ...
  { label: "Cosecha",             icon: Scissors,        path: "/cosecha",          modulo: "cosecha",           iconColor: "text-amber-400" },
  { label: "Post-cosecha",        icon: Package,         path: "/post-cosecha",     modulo: "post-cosecha",      iconColor: "text-orange-400" },
  { label: "Producción",          icon: Factory,         path: "/produccion",       modulo: "produccion",        iconColor: "text-rose-400" },
